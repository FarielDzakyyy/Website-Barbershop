               ...
               <section class="section service" id="services" aria-label="services">
                    <div class="container">
                         ...
                         <p class="section-text text-center">
                              Lebih dari sekadar potong rambut. Di Haircut, nikmati relaksasi dan pelayanan personal
                              dari para ahli cukur kami. Tinggalkan kami dengan gaya baru dan semangat yang disegarkan.
                         </p>
                         ...
                         <ul class="grid-list">
                              ...
                              <li>
                                   <div class="service-card">
                                        ...
                                        <p class="card-text">
                                             Mau coba gaya baru, tapi bingung? Konsultasikan langsung dengan Haircut
                              ...
                              <li>
                                   <div class="service-card">
                                        ...
                                        <p class="card-text">
                                             Mulai dengan yang terbaik. Nikmati layanan keramas premium di Haircut
                              ...
                              <li>
                                   <div class="service-card">
                                        ...
                                        <p class="card-text">
                                             Rasakan ketenangan yang mendalam dengan layanan
                                             Body Treatments kami. Dirancang khusus untuk memulihkan energi dan
                              ...
                              <li>
                                   <div class="service-card">
                                        ...
                                        <p class="card-text">
                                             Rasakan kemewahan Beauty & Spa yang tak tertandingi. Manjakan diri Anda
                                             dengan perawatan premium yang akan menyegarkan pikiran, tubuh, dan jiwa.
                              ...
                              <li>
                                   <div class="service-card">
                                        ...
                                        <p class="card-text">
                                             Rasakan perbedaan Stylist Shaving kami. Dengan presisi dan keahlian tinggi,
                                             Haircut kami akan membentuk jenggot atau rambut Anda menjadi gaya yang
                                             sempurna, menonjolkan fitur terbaik wajah Anda. Siap untuk tampilan yang
                                             lebih tajam?
                                        </p>
                              ...
                              <li>
                                   <div class="service-card">
                                        ...
                                        <p class="card-text">
                                             Beranikan diri untuk tampil beda dengan layanan Multi Hair Colors kami!
                                             Biarkan stylist ahli kami menciptakan kombinasi warna unik yang
