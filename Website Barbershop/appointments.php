...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if ($result->num_rows > 0) {
            echo "<script>alert('Maaf, waktu tersebut sudah dipesan. Mohon pesan 30 menit kedepan dari waktu berikut. Silakan pilih waktu lain.'); window.location.href='gagal.php';</script>";
        } else {
